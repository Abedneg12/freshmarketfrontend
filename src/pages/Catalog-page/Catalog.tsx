                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2">
                    {categories.map(category => <li key={category.id}>
                        <button className={`text-sm w-full text-left py-1 px-2 rounded-md ${activeCategory === category.id ? 'bg-green-50 text-green-700 font-medium' : 'text-gray-600 hover:bg-gray-50'}`} onClick={() => setActiveCategory(category.id)}>
                          {category.name}
                        </button>
                      </li>)}
                  </ul>
