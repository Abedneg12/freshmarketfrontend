      ...
      <div className="p-6 space-y-6">
        ...
        <form onSubmit={onSubmit} className="space-y-8">
          ...
          <div>
            ...
            <textarea id="description" rows={4} value={description} onChange={e => setDescription(e.target.value)} className="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm" placeholder="Enter product description..." />
          </div>
          {/* Store Allocation */}
          <div>
